...
import serenitylabs.tutorials.vetclinic.playingball.sales.model.SalesTax;
...
public class WhenApplyingSalesTaxTests {
    ...
    public WhenApplyingSalesTaxTests(int quantity, String name, ProductCategoryEnum cateogory, double unitPrice, double expectedRate, String expectedRateName, double expectedAmount) {
    ...
    public void items_should_be_charged_at_the_correct_rate() {
        // GIVEN
        LineItemEntity crisps = LineItemEntity.forASaleOf(quantity)
                .itemCalled(name)
